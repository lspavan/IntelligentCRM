...
<body>
	...
	int draw5 = 0;
	int draw6 = 0;
	System.out.println("present page called");
	int dep = 0;
	...
	Connection con1 = GetCon.getCon();
		try {
			...
			System.out.println("First day: " + previousMonth.withDayOfMonth(1));
			System.out.println("Last day: " + previousMonth.withDayOfMonth(previousMonth.lengthOfMonth()));
			System.out.println("accno in pie" + accno.toString());
			
			DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MMM/YYYY");
		      
		      String startDate=formatter.format((previousMonth.withDayOfMonth(1)));
		      String endDate=formatter.format(previousMonth.withDayOfMonth(previousMonth.lengthOfMonth()));
