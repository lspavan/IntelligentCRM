...
<body>
	...
	int draw5 = 0;
	int draw6 = 0;
	System.out.println("complete page called");
	int dep = 0;
	...
	String acc=accno.toString();
		try {
			...
			DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MMM/YYYY");
		      ...
		      String startDate=formatter.format((today.withDayOfMonth(1)));
		      String endDate=formatter.format(today.withDayOfMonth(today.lengthOfMonth()));
		...
		<script type="text/javascript">
		 ...
		 // Load the Visualization API and the piechart package.
	      ...
	      function drawChart() {
	        ...
	        // Set chart options
	        var options = {'title':'Your present month usage...',
	                       'width':2000,
	                       'height':500};
